...
const enterpriseValidationRules = () => {
  return [
    ...
    body("foto_card").optional().isLength({ max: 500 }).withMessage("La foto de la card excede el largo maximo"),
    body("foto_emprendimiento").optional().isLength({ max: 500 }).withMessage("La foto del emprendimiento excede el largo maximo"),
  ];
};
